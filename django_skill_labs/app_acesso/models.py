...
class Sistema(models.Model):
    nome = models.CharField(max_length=100) # Classe que define o nome do sistema, sendo este do tipo caracter 

    def __str__(self):
        return self.nome # Função que retorna o nome do Sistema inserido pelo usuário

class Cliente(models.Model):
    nome = models.CharField(max_length=100) # Classe que define o nome do cliente, sendo este do tipo caracter
